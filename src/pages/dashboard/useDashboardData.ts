...
export const MOCK_UPCOMING_ACTIVITIES: Activity[] = [
  { id: 1, title: 'Atelier peinture aquarelle', activity_type: 'atelier_creatif', description: '', date: addDays(1), time_start: '10:00', time_end: '11:30', location: 'Salle animation', max_participants: 12, actual_participants: 0, animator_name: 'Marie Dupont', status: 'planned', materials_needed: '', notes: '', linked_project_id: null, synced_from: '', last_sync_at: null, external_id: null, is_shared: 1, created_at: '' },
  { id: 2, title: 'Loto musical', activity_type: 'jeux', description: '', date: addDays(2), time_start: '14:30', time_end: '16:00', location: 'Salle polyvalente', max_participants: 30, actual_participants: 0, animator_name: 'Marie Dupont', status: 'planned', materials_needed: '', notes: '', linked_project_id: null, synced_from: '', last_sync_at: null, external_id: null, is_shared: 1, created_at: '' },
  { id: 3, title: 'Gym douce', activity_type: 'sport', description: '', date: addDays(3), time_start: '09:30', time_end: '10:30', location: 'Salle de gym', max_participants: 15, actual_participants: 0, animator_name: 'Claire Moreau', status: 'planned', materials_needed: '', notes: '', linked_project_id: null, synced_from: '', last_sync_at: null, external_id: null, is_shared: 1, created_at: '' },
  { id: 4, title: 'Concert chorale école primaire', activity_type: 'intergenerationnel', description: '', date: addDays(7), time_start: '14:00', time_end: '15:30', location: 'Hall d\'accueil', max_participants: 50, actual_participants: 0, animator_name: 'Marie Dupont', status: 'planned', materials_needed: '', notes: '', linked_project_id: null, synced_from: '', last_sync_at: null, external_id: null, is_shared: 1, created_at: '' },
  { id: 5, title: 'Fête des anniversaires — Avril', activity_type: 'fete', description: '', date: addDays(10), time_start: '15:00', time_end: '17:00', location: 'Salle polyvalente', max_participants: 40, actual_participants: 0, animator_name: 'Marie Dupont', status: 'planned', materials_needed: '', notes: '', linked_project_id: null, synced_from: '', last_sync_at: null, external_id: null, is_shared: 1, created_at: '' },
];
